...
<div class="center">
    ...
    <div class="text">
        ...
        <p>"Elif Towers" - ультрасовременный ЖК бизнес-класса.</p>
        <br>
        <p>Расположен в старом центре города Алматы.</p>
        <p>На пересечение улиц Айтеке би и Сейфуллина.</p>
        <br><br>
        <h1>Застройщик данного ЖК - "Dial Stroy"</h1>
        <br>
        <button onclick="location.href = 'https:\/\/www.youtube.com/watch?v=c_Sdx85uU9Y'">Посмотреть видео</button>
        <br>
