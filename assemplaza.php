...
.startContent {
  ...
  margin-bottom: 15px;
  background: url("./public/imgs/products/assemplaza.jpg");
...
<div class="feedback">
  <form action="./app/feedback.php?path=assemplaza" method="POST" class="feedBack">
...
<div class="center">
    ...
    <div class="text">
        ...
        <p>"ASSEM PLAZA" - ультрасовременный ЖК бизнес-класса.</p>
        <br>
        <p>Расположен в старом центре города Алматы.</p>
        <p>На пересечение улиц Толе би и Ауэзова.</p>
        <br><br>
    ...
    <div class="imgs">
        <img src="./public/imgs/assemplaza/1.jpg">
        <img src="./public/imgs/assemplaza/2.jpg">
        <img src="./public/imgs/assemplaza/3.jpg">
        <img src="./public/imgs/assemplaza/4.jpg">
        <img src="./public/imgs/assemplaza/5.jpg">
        <img src="./public/imgs/assemplaza/6.jpg">
        <img src="./public/imgs/assemplaza/7.jpg">
    </div>
</div>
